...
function Hackernew({ item }: { item: TheNews }) {
  return (
    <a href={item.link}>
      <article className="p-3 bg-secondary-glass rounded-lg border-glass">
        <div className="flex items-start">
          <Image src={TriangleIcon} alt="gradient triangle" className="mt-[.3rem] w-3" />
        ...
        <div className="ml-[1.4rem] mt-1 flex items-center gap-x-2">
          ...
          <h2 className="text-lightSecondary text-[.8rem] font-medium w-full threedots">{item.user}</h2>
        </div>
