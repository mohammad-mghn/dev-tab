...
import { BinIcon } from "@/constants/icons";
    ...
    <div className="relative w-[4rem] h-[4rem] lg:w-[5.5rem] lg:h-[5.5rem] bg-secondary-glass flex flex-col justify-center items-center border-glass rounded-md group">
      ...
      >
        <img
          src={icon}
          alt={title}
          className="w-6 rounded-md max-h-6 lg:w-10 lg:max-h-10"
        />
        <h2 className="px-1 text-[.6rem] lg:text-[.75rem] w-full threedots text-light text-center">
          {title}
        </h2>
      </a>
